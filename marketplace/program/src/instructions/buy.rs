...
use mpl_auction_house::{
    self, cpi::accounts::AuctioneerBuy as AHBuy, program::AuctionHouse as AuctionHouseProgram,
    AuctionHouse,
};

use crate::constants::{AUCTIONEER, FEE_PAYER, LISTING_CONFIG, PREFIX};
...
impl<'info> From<&mut AuctioneerBuy<'info>> for AHBuy<'info> {
    fn from(accounts: &mut AuctioneerBuy<'info>) -> Self {
        AHBuy {
...
pub fn auctioneer_buy(
    ...
    let cpi_accounts: AHBuy = ctx.accounts.into();
