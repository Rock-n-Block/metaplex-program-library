...
import {
  TimedAuctionConfig,
  timedAuctionConfigBeet,
} from '../types/TimedAuctionConfig'
...
export type ListingConfigArgs = {
  timedAuctionConfig: beet.COption<TimedAuctionConfig>
  minBid: beet.bignum
  highestBid: Bid
  bump: number
}
...
export class ListingConfig implements ListingConfigArgs {
  private constructor(
    readonly timedAuctionConfig: beet.COption<TimedAuctionConfig>,
    readonly minBid: beet.bignum,
   ...
   * {@link ListingConfig} for the provided args.
   *
   * @param args need to be provided since the byte size for this account
   * depends on them
   */
  static byteSize(args: ListingConfigArgs) {
    const instance = ListingConfig.fromArgs(args)
    return listingConfigBeet.toFixedFromValue({
      accountDiscriminator: listingConfigDiscriminator,
      ...instance,
    }).byteSize
  }
  ...
  static async getMinimumBalanceForRentExemption(
    args: ListingConfigArgs,
    connection: web3.Connection,
    commitment?: web3.Commitment
  ): Promise<number> {
    return connection.getMinimumBalanceForRentExemption(
      ListingConfig.byteSize(args),
      commitment
    )
  }
  ...
  pretty() {
    return {
      timedAuctionConfig: this.timedAuctionConfig,
      minBid: (() => {
        const x = <{ toNumber: () => number }>this.minBid
 ...
 * @category generated
 */
export const listingConfigBeet = new beet.FixableBeetStruct<
  ListingConfig,
  ListingConfigArgs & {
...
>(
  [
    ...
    ['timedAuctionConfig', beet.coption(timedAuctionConfigBeet)],
    ['minBid', beet.u64],
    ['highestBid', bidBeet],
    ['bump', beet.u8],
  ],
