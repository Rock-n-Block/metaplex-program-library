...
createErrorFromCodeLookup.set(0x1771, () => new SignerNotAuthError())
createErrorFromNameLookup.set('SignerNotAuth', () => new SignerNotAuthError())

/**
 * AuctionStartTimeInThePast: 'The auction start time can't be in the past'
 *
 * @category Errors
 * @category generated
 */
export class AuctionStartTimeInThePastError extends Error {
  readonly code: number = 0x1772
  readonly name: string = 'AuctionStartTimeInThePast'
  constructor() {
    super("The auction start time can't be in the past")
    if (typeof Error.captureStackTrace === 'function') {
      Error.captureStackTrace(this, AuctionStartTimeInThePastError)
    }
  }
}
...
createErrorFromCodeLookup.set(
  0x1772,
  () => new AuctionStartTimeInThePastError()
)
createErrorFromNameLookup.set(
...
/**
 * MinBidMusntBeZero: 'Minimal bid value can't be zero'
 *
 * @category Errors
 * @category generated
 */
export class MinBidMusntBeZeroError extends Error {
  readonly code: number = 0x1773
  readonly name: string = 'MinBidMusntBeZero'
  constructor() {
    super("Minimal bid value can't be zero")
    if (typeof Error.captureStackTrace === 'function') {
      Error.captureStackTrace(this, MinBidMusntBeZeroError)
    }
  }
}

createErrorFromCodeLookup.set(0x1773, () => new MinBidMusntBeZeroError())
createErrorFromNameLookup.set(
  'MinBidMusntBeZero',
  () => new MinBidMusntBeZeroError()
)

/**
 * IncorrectBidStep: 'Any bid must be a multiple of the bid step - 0.01'
 *
 * @category Errors
 * @category generated
 */
export class IncorrectBidStepError extends Error {
  readonly code: number = 0x1774
  readonly name: string = 'IncorrectBidStep'
  constructor() {
    super('Any bid must be a multiple of the bid step - 0.01')
    if (typeof Error.captureStackTrace === 'function') {
      Error.captureStackTrace(this, IncorrectBidStepError)
    }
  }
}

createErrorFromCodeLookup.set(0x1774, () => new IncorrectBidStepError())
createErrorFromNameLookup.set(
  'IncorrectBidStep',
  () => new IncorrectBidStepError()
)
...
createErrorFromCodeLookup.set(0x1775, () => new AuctionNotStartedError())
createErrorFromNameLookup.set(
  'AuctionNotStarted',
  () => new AuctionNotStartedError()
)
...
createErrorFromCodeLookup.set(0x1776, () => new AuctionEndedError())
...
createErrorFromCodeLookup.set(0x1777, () => new BidTooLowError())
 ...
 * @category generated
 */
export class BidStepTooSmallError extends Error {
  readonly code: number = 0x1778
  readonly name: string = 'BidStepTooSmall'
  constructor() {
    super('')
    if (typeof Error.captureStackTrace === 'function') {
      Error.captureStackTrace(this, BidStepTooSmallError)
    }
  }
}

createErrorFromCodeLookup.set(0x1778, () => new BidStepTooSmallError())
createErrorFromNameLookup.set(
  'BidStepTooSmall',
  () => new BidStepTooSmallError()
)
...
createErrorFromCodeLookup.set(0x1779, () => new NotHighestBidderError())
createErrorFromNameLookup.set(
  'NotHighestBidder',
  () => new NotHighestBidderError()
)
...
createErrorFromCodeLookup.set(0x177a, () => new AuctionActiveError())
